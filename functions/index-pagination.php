...
if ( ! function_exists( 'a2b_pagination' ) ) {
	function a2b_pagination() {
		global $wp_query;
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Newer', 'a2b'),
			'next_text' => __('Older <i class="fas fa-angle-right"></i>', 'a2b'),
			'type' => 'list'
		) );
