...
if ( ! function_exists('a2b_setup') ) {
	function a2b_setup() {
		...
		// a2b cannot support extra-wide blocks
...
add_action('init', 'a2b_setup');

if ( ! function_exists( 'a2b_avatar_attributes' ) ) {
	function a2b_avatar_attributes($avatar_attributes) {
...
add_filter('get_avatar','a2b_avatar_attributes');

if ( ! function_exists( 'a2b_author_avatar' ) ) {
	function a2b_author_avatar() {

		echo get_avatar('', $size = '96');
	}
}

if ( ! function_exists( 'a2b_author_description' ) ) {
	function a2b_author_description() {
		echo get_the_author_meta('user_description');
	}
}

if ( ! function_exists( 'a2b_post_date' ) ) {
	function a2b_post_date() {
